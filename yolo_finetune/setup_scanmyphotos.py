...
# ///
"""One-time setup: copy ScanMyPhotos files from originals/ to working directory."""
...
ORIGINALS_DIR = BASE_DIR.parent / "originals"
WORKING_DIR = BASE_DIR / "scanmyphotos"
MANIFEST_FILE = BASE_DIR / "scanmyphotos_manifest.json"

# PostgreSQL connection (matches dedup config)
DB_CONFIG = {
    "host": "localhost",
    "port": 5432,
    "dbname": "dedup",
    "user": "dedup",
    "password": "dedup_local_dev",
}

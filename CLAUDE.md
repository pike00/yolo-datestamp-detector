...
- Samples: `photo_mapping_samples/` (100 pre-selected JPGs across discs)
...
## Key Documentation
- `PLAN.md` — Master plan for the full 77K photo consolidation (Phases 1-3)
- `HANDOFF.md` — Detailed handoff for scanned photo date extraction pipeline
- `DATE_EXTRACTION_APPROACHES.md` — Scored analysis of 6 approaches with costs
- `CLAUDE_CODE_WORKFLOW.md` — Claude Code patterns, hooks, and optimization techniques
...
See `CLAUDE_CODE_WORKFLOW.md` for detailed guidance on:

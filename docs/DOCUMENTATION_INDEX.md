...
| `PLAN.md` | Master plan: Phases 1-3, timeline, success criteria | ✅ Active |
| `HANDOFF.md` | Detailed handoff for date extraction pipeline | ✅ Active |
| `DATE_EXTRACTION_APPROACHES.md` | Analysis of 6 approaches with costs | ✅ Complete |

## 🎯 Claude Code Patterns (New - Read Before Major Work)

| File | When to Use |
|------|-------------|
| `CLAUDE_CODE_WORKFLOW.md` | Before starting any new session — refresher on best practices |
| `IMPLEMENTATION_CHECKLIST.md` | Weekly — track Phase 1 and Phase 2 progress |
